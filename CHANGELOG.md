...
- Multi-language storefront (23 locales, RTL for Arabic/Hebrew), browser detect + manual switcher
- Multi-currency selector with admin exchange rates (API-ready)
- Light / Dark / System theme with persisted preference
- Admin → Languages & currency dashboard; data-driven locale/currency registries

## [0.4.2] - 2026-07-16

### Added

- Admin Backups: create/download/upload/restore, automatic schedule, retain policy, cron endpoint
- Activity logs with search for admin audit trail
