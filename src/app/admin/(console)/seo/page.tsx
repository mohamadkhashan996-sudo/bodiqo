...
export default async function AdminSEOPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <h1 className="font-[family-name:var(--font-display)] text-4xl">SEO</h1>
      <p className="text-sm text-[#f3efe6]/55">
        Global SEO defaults — also under Settings → SEO.
      </p>
      <div className="rounded-2xl border border-white/10 bg-[#121212] p-6 text-sm text-[#f3efe6]/70">
        ...
        <p className="mt-3 text-[#f3efe6]/45">
          ...
          operations. Extended seo editing continues to expand on this
          foundation.
        </p>
      </div>
    </div>
