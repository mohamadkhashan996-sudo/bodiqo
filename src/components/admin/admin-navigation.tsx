...
const nav: NavItem[] = [
  ...
  { href: "/admin/banned", label: "Banned users", icon: Ban, permission: "users:read" },
  { href: "/admin/content", label: "Content review", icon: FileStack, permission: "content:read" },
  { href: "/admin/settings", label: "System settings", icon: Settings, permission: "settings:read" },
