...
export function AppNavigation({
  ...
  const staff =
    ...
    role === "SUPER_ADMIN";
  return (
    <aside className="sticky top-0 z-30 flex h-auto w-full items-center justify-between border-b border-[var(--mist)] bg-[var(--cloud)]/80 px-5 py-4 backdrop-blur-xl lg:h-screen lg:w-64 lg:flex-col lg:items-stretch lg:border-r lg:border-b-0 lg:px-6 lg:py-8">
      <BrandLockup href="/home" />
      <nav className="mt-0 flex gap-1 overflow-x-auto lg:mt-12 lg:block lg:space-y-1">
      ...
      <p className="hidden text-xs leading-5 text-[var(--muted)] lg:block">
        Make space for the people and ideas that move you.
      </p>
    </aside>
  );
}
